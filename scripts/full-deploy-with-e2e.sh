...
echo "🔨 Step 2: Building site (without E2E tests)..."
npm run build
echo -e "  ${GREEN}✓${NC} Build complete"

# Step 2b: Run E2E tests separately
echo "🧪 Step 2b: Running E2E tests..."
npm run test:e2e || echo -e "  ${YELLOW}⚠${NC} E2E tests failed but continuing deployment"
echo ""
