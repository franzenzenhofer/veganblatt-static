...
import { ImageValidator } from './core/ImageValidator';
...
export class SiteGenerator {
  ...
  constructor(private config: SiteConfig) {
    ...
    this.validator = new ImageValidator(this.config, this.fs, this.content, this.image);
  }
  ...
  async generate(): Promise<void> {
    ...
    await this.validator.validateFeaturedImageMetadata();
